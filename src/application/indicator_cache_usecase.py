...
from infrastructure.persistence.indicator_cache import (
    clear_indicator_cache,
    save_indicator_batch,
    save_indicator_cache_range,
)
...
class IndicatorCacheUsecase:
    ...
    def _apply_indicators(self, record, df, indicators):
        ...
        for indicator in indicators:
            values = indicator.batch_apply_for_df(record, df)
